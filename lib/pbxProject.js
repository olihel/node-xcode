...
pbxProject.prototype.addInfoPlistFile = function (lang) {
    var fileName = 'InfoPlist.strings';
    var langGroup = lang + '.lproj';
    var file = new pbxFile(langGroup + '/' + fileName);
    ...
    (function () {
        ...
        var fRefObj = pbxFileReferenceObj(file);
        fRefObj.path = fileName;
        self.pbxFileReferenceSection()[file.fileRef] = fRefObj;
        self.pbxFileReferenceSection()[commentKey] = pbxFileReferenceComment(file);
    }());

    this.pbxGroupByName(langGroup).children.push(pbxGroupChild(file));
